...
struct OcarinaView: View {
    ...
    @State var diatonicAnswerString = ""
    ...
    func next() {
        fourNote = false
        notes.removeAll()
        rootNote = UInt8(Int.random(in: 59...75)) //leave room for my whistling range
        ...
        if diatonic {
            ...
            notes.removeAll()
            rootNote = UInt8(Int.random(in: 57...65))
            notes.append(rootNote)
            switch rootNote % 12 {
            case 0: rootNoteLetter = "C"
            case 1: rootNoteLetter = "D♭"
            ...
            switch scaleType {
                ...
                //Major scale
            case 1:
                let decision = Int.random(in: 1...4) // four cases now
                ...
                case 3: //four notes straight up or down!
                    fourNote = true
                    let coinflip = 1
                    if coinflip == 1 { //ascending first
        ...
        if individual {
            ...
            prompt = ""
            notes.removeAll()
            rootNote = UInt8(Int.random(in: 59...75)) //leave room for my vocal range
            notes.append(rootNote)
            switch rootNote % 12 {
            case 0: rootNoteLetter = "C"
            case 1: rootNoteLetter = "D♭"
